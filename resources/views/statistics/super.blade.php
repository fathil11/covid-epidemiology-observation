...
<div class="container">
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-3 col-6">
            <div class="bg-danger rounded text-center text-white py-3">
                <h4 class="">Konfirmasi <br>Seminggu Terakhir</h4>
                <h2 class="font-weight-bold">{{ $statistics['last_positive'] }}</h2>
            </div>
        </div>
        ...
        <div class="col-md-3 col-6 mt-md-0 mt-3">
            <div class="bg-success rounded text-center text-white py-3">
                <h4 class="">Negatif <br>Seminggu Terakhir</h4>
                <h2 class="font-weight-bold">{{ $statistics['last_negative'] }}</h2>
            </div>
        </div>
    ...
    <div class="row mt-5">
        <div class="col-md-12 table-responsive">
            <h4 class="text-center">Tabel Statistik Per Kecamatan</h4>
